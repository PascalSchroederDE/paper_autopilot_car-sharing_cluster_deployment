...
\setzetitel{Deployment of Autopilot Car Sharing Service and requirements within IBM Cloud Cluster}
\setzedatumAbgabe{11/03/2019}
\setzefirma{IBM Deutschland GmbH}
\setzefirmenort{Dublin}
\setzeabgabeort{Mannheim}
\setzestudiengang{Applied Computer Science}
\setzedhbw{Mannheim}
\setzebetreuer{Martin Mevissen}
\setzeabteilung{IBM Research}
\setzezeitraum{19.11.2018-08.02.2019}
